...
train = open("/n/work1/feng/data/scripts_4emotion_ASR_total/IEMOCAP_total_hap.csv","w+")
wordid = open("/n/work1/ueno/data/librispeech/texts/word.id","r")
emotioncount = open("/n/work1/feng/data/scripts_4emotion_ASR_total/emotioncount_hap_delete.txt","w+")
        ...
        for File in file_list:
            ...
            while line:
                if name in line:
                    ...
                    temp = temp.strip()
                    if "exc" in emotion or "hap" in emotion:
