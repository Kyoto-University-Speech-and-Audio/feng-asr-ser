...
train = open("/n/work1/feng/data/scripts_4emotion_ASR_improvised/1/IEMOCAP_train.csv","w+")
test = open("/n/work1/feng/data/scripts_4emotion_ASR_improvised/1/IEMOCAP_test.csv","w+")
wordid = open("/n/work1/ueno/data/librispeech/texts/word.id","r")
emotioncount = open("/n/work1/feng/data/scripts_4emotion_ASR_improvised/1/emotioncount.txt","w+")
