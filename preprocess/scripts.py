...
train = open("/n/sd3/feng/data/scripts_3emotion/IEMOCAP_train.csv","w+")
test = open("/n/sd3/feng/data/scripts_3emotion/IEMOCAP_test.csv","w+")
wordid = open("/n/sd3/feng/data/swb/swb/words.txt","r")
emotioncount = open("/n/sd3/feng/data/scripts_3emotion/emotioncount.txt","w+")
...
emotioncount.write("positive:"+str(hap)+"\n")
emotioncount.write("negative:"+str(sad)+"\n")
