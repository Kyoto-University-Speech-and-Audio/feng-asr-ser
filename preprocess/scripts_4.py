...
train = open("/n/work1/feng/data/scripts_4emotion/IEMOCAP_train.csv","w+")
test = open("/n/work1/feng/data/scripts_4emotion/IEMOCAP_test.csv","w+")
wordid = open("/n/sd7/trung/csp/data/swb/words.txt","r")
emotioncount = open("/n/work1/feng/data/scripts_4emotion/emotioncount.txt","w+")
