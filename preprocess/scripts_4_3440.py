...
train = open("/n/work1/feng/data/scripts_4emotion_3440/IEMOCAP_train.csv","w+")
test = open("/n/work1/feng/data/scripts_4emotion_3440/IEMOCAP_test.csv","w+")
wordid = open("/n/work1/feng/data/word.id","r")
emotioncount = open("/n/work1/feng/data/scripts_4emotion_3440/emotioncount.txt","w+")
htkpos = "/n/work1/feng/data/IEMOCAP_htk/"
